...
This directory is for all WELL DOCUMENTED notebooks one believes are worth sharing, both polished and exploratory. 
Each method has its own directory with exploratory and validation folders. Feel free to add more methods as they come about, keeping the same structure.
